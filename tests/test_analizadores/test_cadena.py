...
class TestCadenaAFD:
    ...
    def test_cadena_simple(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"Hola mundo"', 0)
        assert valido == True
    ...
    def test_cadena_sin_cerrar(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"Cadena sin cerrar', 0)
        assert valido == False
        assert lexema == ''
        assert consumidos == 0
    ...
    def test_no_es_cadena(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('No es cadena', 0)
        assert valido == False
        assert lexema == ''
        assert consumidos == 0
    ...
    def test_cadena_con_escape_comillas(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"Cadena con \\"escape\\""', 0)
        assert valido == True
    ...
    def test_cadena_con_escape_salto(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"Cadena con\\nSalto"', 0)
        assert valido == True
    ...
    def test_cadena_con_escape_tabulador(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"Cadena\\tTabulador"', 0)
        assert valido == True
    ...
    def test_cadena_con_escape_barra(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"Cadena\\\\Barra"', 0)
        assert valido == True
    ...
    def test_cadena_con_unicode(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"áéíóú ñÑ"', 0)
        assert valido == True
    ...
    def test_cadena_con_escape_invalido(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"Cadena con \\x"', 0)
    ...
    def test_cadena_con_espacios(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"   espacios   "', 0)
        assert valido == True
    ...
    def test_cadena_con_tabulador_real(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"Cadena con\ttabulador"', 0)
        assert valido == True
    ...
    def test_cadena_con_caracteres_control(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"\\a\\b\\f\\r\\v"', 0)
        assert valido == True
    ...
    def test_cadena_con_octal(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"\\141"', 0)  # 'a' en octal
        assert valido == True
        assert lexema == '"\\141"'
        assert consumidos == len(lexema)
    ...
    def test_cadena_con_hexadecimal(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"\\x61"', 0)  # 'a' en hex
        assert valido == True
        assert lexema == '"\\x61"'
        assert consumidos == len(lexema)
    ...
    def test_cadena_con_unicode_escape(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('"\\u0061"', 0)  # 'a' en Unicode
        assert valido == True
        assert lexema == '"\\u0061"'
        assert consumidos == len(lexema)
    ...
    def test_cadena_con_template_literal(self, afd):
        ...
        valido, lexema, consumidos, _ = afd.analizar('`template literal`', 0)
